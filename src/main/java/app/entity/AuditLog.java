...
@javax.persistence.Table(name = "\"AUDITLOG\"")
@XmlRootElement
@CronappSecurity
...
public class AuditLog implements Serializable {
    ...
    * @generated
    */
    @Column(name = "command", nullable = true, unique = false, insertable=true, updatable=true)
    ...
    * @generated
    */
    public AuditLog setId(java.lang.String id) {
        this.id = id;
        return this;
    }
    /**
